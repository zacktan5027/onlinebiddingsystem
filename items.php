...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container">
        <section class="py-5 bg-warning rounded shadow">
            <div class="container">
                <div class="row px-4 px-lg-5 py-lg-4 align-items-center">
                    <div class="col-lg-8">
                        <h1 class="h2 text-uppercase text-shadow mb-0">Item List
                            <?php
                            if (isset($_GET["category"])) {
                    ...
                    <div class="col-lg-4 bg-waring text-lg-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-warning justify-content-lg-end mb-0 px-0">
                                <li class="breadcrumb-item  text-shadow"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item  text-shadow" style="color: #8a7a00;" aria-current="page">All items</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        if (isset($_POST["searchItem"])) {
            ...
            $sql = "SELECT * FROM `user` WHERE (firstName = '$searchItem' OR lastName = '$searchItem') AND account_type='user'";
            $query = mysqli_query($conn, $sql);

            if (mysqli_num_rows($query) > 0) {
                $seller = mysqli_fetch_array($query);
        ?>
                <section class="mt-4 shadow">
