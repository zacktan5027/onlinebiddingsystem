...
$sql = $conn->query("SELECT * FROM bidding NATURAL JOIN item JOIN favourite ON favourite.itemID=item.itemID WHERE  favourite.userID = " . $_SESSION["user"]["id"] . "");
$biddingItems = [];
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container">
        <h1 class="headline mb-3 font-weight-bold text-uppercase">My Wish List</h1>
        <hr>
                        ...
                        if (!empty($biddingItems)) {
                            foreach ($biddingItems as $key => $biddingItem) {
                                ...
                                if ($biddingItem["biddingStatus"] == "start") { ?>
                                    <div class="col-sm-3">
                                        <div class="card mx-auto my-1 rounded" style="width:200px">
                                            <?php
