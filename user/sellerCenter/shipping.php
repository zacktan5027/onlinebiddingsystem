                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="shippingManager.php" method="post" onsubmit="return checkEditShipping(this)" novalidate>
                                                            <div class="form-group">
                                                                <label for="trackingNumber">Tracking Number:</label>
                                                                <input type="hidden" name="biddingID" value="<?= $item["biddingID"] ?>">
                                                                <input type="text" name="trackingNumber" id="editTracking<?= $item["biddingID"] ?>" class="form-control" maxlength="15" placeholder="Enter tracking number" value=<?= $row["tracking_number"] ?> required>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="courierName" id="editCourierName<?= $item["biddingID"] ?>" class="form-control" value="<?= $row["courier_name"] ?>" required>
                                    ...
                                    ?>
                                        <button type="button" class="btn btn-primary text-uppercase text-nowrap" style="width:100%" data-toggle="modal" data-target="#addTracking<?= $item["biddingID"] ?>">Add Tracking Number</button>
                                        <!-- Modal -->
                                        <div class="modal fade" id="addTracking<?= $item["biddingID"] ?>" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="shippingManager.php" method="post" onclick="return checkAddShipping(this)" class="needs-validation" novalidate>
                                                            <div class="form-group">
                                                                <label for="trackingNumber">Tracking Number:</label>
                                                                <input type="hidden" name="biddingID" value="<?= $item["biddingID"] ?>">
                                                                <input type="text" name="trackingNumber" id="addTracking<?= $item["biddingID"] ?>" class="form-control" maxlength="15" placeholder="Enter tracking number" required>
                                                                <div class="invalid-feedback">
                                                                    Please enter a tracking number
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="courierName">Courier Name</label>
                                                                <select name="courierName" id="addCourierName<?= $item["biddingID"] ?>" class="form-control" required>
                                                                    <option value="">Please choose one</option>
                                                                    <option value="AirAsia Courier">AirAsia Courier</option>
                                                                    <option value="AIRPAK Express">AIRPAK Express</option>
                                                                    <option value="Avanti Worldwide Express AWE">Avanti Worldwide Express AWE</option>
                                                                ...
                                                                <div class="invalid-feedback">
                                                                    Please choose a courier service
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
