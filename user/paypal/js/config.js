...
select_country_dropdown = function () {
  ...
  for (
    var i = 0;
    i < document.getElementById("countrySelect").options.length;
    i++
  ) {
    if (
      document.getElementById("countrySelect").options[i].value == buyer_country
    ) {
  ...
  apm_country_list.forEach(function (country_object) {
    if (country_object.country === buyer_country) {
      ...
      document.getElementById("recipient_name").value =
        country_object.recipient_name;
      document.getElementById("line1").value =
        country_object.address.address_line_1;
      document.getElementById("line2").value =
        country_object.address.address_line_2;
