                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="staffManager.php" method="post" enctype="multipart/form" class="needs-validation" novalidate>
                                                    ...
                                                    <div class="modal fade" id="editStaff<?= $staff["staffID"] ?>" tabindex="-1" aria-labelledby="editStaffLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="staffManager.php" id="editStaffForm<?= $staff["staffID"] ?>" method="post" enctype="multipart/form" onsubmit="return checkEditStaff(this)" class="needs-validation" novalidate>
